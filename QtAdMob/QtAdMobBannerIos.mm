...
void QtAdMobBannerIos::SetAppId(const QString& appId)
{
    if (!IsValid())
    {
        return;
    ...
    [GADMobileAds configureWithApplicationID:[NSString stringWithUTF8String:unitId.toUtf8().data()]];
