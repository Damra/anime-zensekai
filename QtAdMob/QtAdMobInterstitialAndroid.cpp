...
void QtAdMobInterstitialAndroid::SetAppId(const QString& appId){
    if (!IsValid())
    {
        return;
    }

    QAndroidJniObject param1 = QAndroidJniObject::fromString(appId);
    m_Activity->callMethod<void>("initializeAppId", "(Ljava/lang/String;)V", param1.object<jstring>());
}
